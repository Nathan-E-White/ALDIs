/*1653038303,,JIT Construction: v1005553938,en_US*/
...
try {
            ...
            with (this) {
                ...
                __d("sdk.Content", ["Log", "sdk.UA", "sdk.domReady"], (function (a, b, c, d, e, f, g) {
                    ...
                    function a(a, b) {
                        ...
                        c.method = b ? "GET" : "POST";
                        k(c);
                        for (var b in a.params) if (Object.prototype.hasOwnProperty.call(a.params, b)) {
                            var d = a.params[b];
                            if (d != null) {
                ...
                __d("fb-error", ["performanceNow", "removeFromArray"], (function (a, b, c, d, e, f) {
                    ...
                    }, l = {access_token: null}, m = 6, n = 6e4, o = 10 * n, p = new Map(), q = 0;
                    ...
                    function s(a) {
                        r();
                        var c = (g || (g = b("performanceNow")))(), d = p.get(a);
                        if (d == null) {
                    ...
                    var aa = typeof window === "undefined" ? "<self.onerror>" : "<window.onerror>", w;
                    ...
                    var D = {aggregateError: c, toReadableMessage: d, toStringParams: f}, ea = 5, E = [];
                    ...
                    var H = {add: F, addFromXHR: G, getAll: fa}, ga = "abcdefghijklmnopqrstuvwxyz012345";
                    ...
                    function M(c) {
                        ...
                        var n = la(c.componentStack), o = n == null ? null : n.map(K),
                        ...
                        var r = ca(c), s = c.loggingSource, t = c.project;
                    ...
                    var N = {formatStackFrame: L, normalizeError: M, ifNormalizedError: ma}, na = "<global.react>",
                        O = [], P = [], Q = 50, R = !1, S = {
                            history: P, addListener: function (a, b) {
                    ...
                    var ua = {createErrorPayload: sa, postError: ta}, $ = null, va = !1;
                    ...
                    var za = function () {
                        ...
                        var b = a.prototype;
                        b.$1 = function (b, c) {
                            var d = String(c), e = this.events, f = this.project, g = this.metadata,
                ...
                __d("flattenPHPQueryData", ["invariant"], (function (a, b, c, d, e, f, g, h) {
                    ...
                    function i(a, b, c) {
                        if (a === null || a === void 0) c[b] = void 0; else if (typeof a === "object") {
                ...
                __d("sdk.Impressions", ["Miny", "QueryString", "UrlMap", "getBlankIframeSrc", "guid", "insertIframe", "sdk.Content", "sdk.Runtime"], (function (a, b, c, d, e, f, g) {
                    ...
                    function i(a, b, c, d) {
                        ...
                        if (b.length <= 2e3) window.fetch(b, e); else {
                            ...
                            for (var b in c) if (Object.prototype.hasOwnProperty.call(c, b)) {
                                var f = c[b];
                                f != null && d.set(b, f)
                            }
                ...
                __d("sdk.XD", ["JSSDKXDConfig", "Log", "QueryString", "Queue", "UrlMap", "guid", "isFacebookURI", "isInstagramURI", "resolveWindow", "sdk.Event", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.feature"], (function (a, b, c, d, e, f, g) {
                    var h = new (c("Queue"))(), i = "parent", j = null, k = /^https:\/\/.*\.(facebook|instagram)\.com$/;
                ...
                __d("ChatPluginStyleUtils", [], (function (a, b, c, d, e, f) {
                    var g = 44, h = 36, i = 17, j = 15, k = 22, l = 20, m = 6, n = 4, o = 16, p = 14, q = 60, r = 44,
                        s = 70, t = 86, u = 63, v = 76, w = 99, x = 114, y = 85, z = 98, A = 12;
                ...
                __d("IframePluginClass", ["Log", "QueryString", "UrlMap", "guid", "sdk.Auth.LoginStatus", "sdk.AuthUtils", "sdk.DOM", "sdk.Event", "sdk.Observable", "sdk.PlatformVersioning", "sdk.PluginUtils", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.XD", "sdk.createIframe"], (function (a, b, c, d, e, f, g) {
                    a = function (a) {
                        ...
                        function b(b, e, f, g) {
                            ...
                            var j = d("UrlMap").resolve("www") + "/plugins/" + f + ".php?", k = {};
                ...
                __d("sdk.cp.Actions", ["DOMEventListener", "MPNExplicitUserInteractions", "MPNLocalState", "MPNSingletonProvider", "sdk.DOM", "sdk.DocumentTitle", "sdk.URI", "sdk.WebStorage", "sdk.cp.Constants"], (function (a, b, c, d, e, f, g) {
                    ...
                    var h = function () {
                        ...
                        b.setDialogAppearance = function (a, b) {
                            if (a == null) return;
                            var c = b.height, e = b.boxShadow, f = b.margin;
                            b = b.width;
                ...
                __d("sdk.XFBML.CustomerChatNew", ["ChatPluginSDKPreLoggingUtils", "DOMEventListener", "IframePluginClass", "Log", "MPNExplicitUserInteractions", "MPNLocalState", "QueryString", "UrlMap", "getFacebookOriginForTarget", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.DialogUtils", "sdk.Event", "sdk.UA", "sdk.WebStorage", "sdk.XD", "sdk.XFBML.CustomerChatWrapper", "sdk.cp.Actions", "sdk.cp.Animation", "sdk.cp.Constants", "sdk.cp.Storage", "sdk.createIframe"], (function (a, b, c, d, e, f, g) {
                    ...
                    a = function (a) {
                        ...
                        e.$CustomerChat27 = function (a) {
                            this.$CustomerChat16({name: "CustomerChat.SDK.Called", event: a})
                        };
                ...
                __d("sdk.XFBML.ShadowDOMLoginButton", ["DOMPlugin", "UrlMap", "sdk.Auth", "sdk.Event", "sdk.LoggingUtils", "sdk.PluginUtils", "sdk.Runtime", "sdk.SVGLogos", "sdk.SharedStringConstants", "sdk.createIframe", "sdk.modFeatureCheck", "sdk.ui"], (function (a, b, c, d, e, f, g) {
                    ...
                    function s() {
                        var a = d("sdk.SVGLogos").facebookWhite({"class": "fb_button_svg_logo login_fb_logo"});
                        return a
                    }
                ...
                __d("sdk.XFBML.MessengerCheckbox", ["FB", "IframePlugin", "Log", "PluginAttrTypes", "sdk.XD"], (function (a, b, c, d, e, f, g) {
                    ...
                    a = c("IframePlugin").withParams({
                        ...
                        subscription_frequency: d("PluginAttrTypes").string,
                        subscription_topic: d("PluginAttrTypes").string
                    });
                    b = a;
                    g["default"] = b
                }), 98);
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1005553938","namespace":"FB","message":"' + e.message + '"}}');
